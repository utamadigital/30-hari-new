        ...
        <div className="grid gap-6 lg:gap-8 md:grid-cols-3">
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-6 lg:p-8 text-left">
            ...
            <ul className="space-y-2 text-sm text-slate-700">
              <li className="flex gap-2"><Check className="h-4 w-4 text-emerald-600" />1.000+ Worksheet Anak Muslim (PDF)</li>
              <li className="flex gap-2"><Check className="h-4 w-4 text-emerald-600" />Bisa print ulang seumur hidup</li>
              <li className="flex gap-2"><Check className="h-4 w-4 text-emerald-600" />Download instan</li>
              <li className="flex gap-2 opacity-50"><AlertTriangle className="h-4 w-4 text-amber-500" />
          ...
          <div className="relative rounded-2xl border-2 border-emerald-600 bg-white p-6 pt-10 lg:p-8 lg:pt-12 text-left shadow-xl">
            ...
            <ul className="space-y-2 text-sm text-slate-700">
              <li className="flex gap-2 font-semibold"><Check className="h-4 w-4 text-emerald-600" />Semua isi Paket Basic</li>
              <li className="flex gap-2"><Check className="h-4 w-4 text-emerald-600" />Program belajar anak muslim 30 hari (harian)</li>
              <li className="flex gap-2"><Check className="h-4 w-4 text-emerald-600" />Target 10–20 menit per hari</li>
              <li className="flex gap-2"><Check className="h-4 w-4 text-emerald-600" />Urutan jelas, anak tidak loncat-loncat</li>
              <li className="flex gap-2"><Check className="h-4 w-4 text-emerald-600" />Lebih mudah konsisten tanpa disuruh</li>
            </ul>
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-6 lg:p-8 text-left">
            ...
            <ul className="space-y-2 text-sm text-slate-700">
              <li className="flex gap-2"><Check className="h-4 w-4 text-emerald-600" />Semua isi Program 30 Hari</li>
              <li className="flex gap-2"><Check className="h-4 w-4 text-emerald-600" />Update worksheet berkala</li>
              <li className="flex gap-2"><Check className="h-4 w-4 text-emerald-600" />Template reward & target anak</li>
              <li className="flex gap-2"><Check className="h-4 w-4 text-emerald-600" />Akses prioritas WA support</li>
            </ul>
